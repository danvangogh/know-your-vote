        ...
        <div className="container">
          <div className="row">
            <div className="col-8">
              ...
              <h4>THE 'GOOD'</h4>
              <p>The fact is that the comments that have been made and the issues that have surfaced over the last few weeks reflect the complexities of race in this country that we've never really worked through - a part of our union that we have yet to perfect. And occasionally it finds voice in the church on Sunday morning, in the pulpit and in the pews. And that's to be expected.

                We are one people, all of us pledging allegiance to the stars and stripes, all of us defending the United States of America. Wright deliver a sermon called "The Audacity of Hope." And during the course of that sermon, he introduced me to someone named Jesus Christ.
              </p>
              <h4>THE 'BAD'</h4>
              <p>And I've found that no matter where I am, or who I'm talking to, there's a common theme that emerges. I'll recruit an army of new teachers, and pay them higher salaries and give them more support. Together, you represent the harmony between tradition and progress. Violent extremists have exploited these tensions in a small but potent minority of Muslims. That is the responsibility we have to one another as human beings. Given our interdependence, any world order that elevates one nation or group of people over another will inevitably fail.
              </p>
            </div>
            <div className="col-4">
              <h3>OPINIONS</h3>
              <div className="card">
                  ...
                  <div className="card-body">
                    <blockquote className="blockquote mb-0">
                      ...
                      <footer className="blockquote-footer">Obama <cite title="Source Title">CBC News</cite></footer>
                    </blockquote>
                  </div>
                </div>
              <div className="card">
                  ...
                  <div className="card-body">
                    <blockquote className="blockquote mb-0">
                      ...
                      <footer className="blockquote-footer">Trudeau <cite title="Source Title">Twitter</cite></footer>
                    </blockquote>
                  </div>
                </div>
            </div>

...
topics = Topic.create!([
  ...
  good: "Trudeau - \"Starting next year, it will no longer be free to pollute anywhere in Canada. Putting a price on pollution is the best way to tackle climate change, because it works.\" May - \"I certainly want to congratulate the prime minister and the minister for environment and climate change for following through on one of their election planks. And for adopting the Green Party approach to pricing carbon. The model that the Prime Minister has now adopted is a smart one.\"
  ",
  bad: "Singh - \"Part of the plan should have been not spending the dollars on purchasing the pipeline… Secondly the targets…the targets are not anywhere near where they need to be. And thirdly… the implementation should always put into consideration the impact on every day families, and concern with who can actually contribute, and make sure that those who are able to reduce their emissions, those who are in the position of producing the most emissions are put in the position of having the most burden.\" Scheer - \"This time next year I plan on being able to tell Canadians that Justin Trudeau’s carbon tax is a thing of the past.\"
  ",
